...
const routes: Routes = [
  { path: '', component: AdminComponent, children: [
      ...
      {
        path: 'projects/add',
        loadComponent: () => import('./views/admin-projects/add-project/add-project.component')
          .then(m => m.AddProjectComponent),
      },
      {
        path: 'projects/:projectID/edit',
        loadComponent: () => import('./views/admin-projects/edit-project/edit-project.component')
      ...
      {
        path: 'users/:userUID',
        loadComponent: () => import('./views/admin-users/admin-user-detail/admin-user-detail.component')
