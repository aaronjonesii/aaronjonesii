...
import { Component, Inject, Input, Pipe, isDevMode, Injectable, EventEmitter, Output, Directive, HostListener, output, effect } from '@angular/core';
...
class ConsoleLoggerService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.3", ngImport: i0, type: ConsoleLoggerService, deps: [{ token: i1$2.MatSnackBar }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
class FirebaseStorageService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.3", ngImport: i0, type: FirebaseStorageService, deps: [{ token: i1$3.Storage }, { token: DOCUMENT }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
class StorageFilePreviewComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.3", ngImport: i0, type: StorageFilePreviewComponent, deps: [{ token: i1$4.Clipboard }, { token: ConsoleLoggerService }, { token: FirebaseStorageService }], target: i0.ɵɵFactoryTarget.Component }); }
...
class LoadingComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.3", ngImport: i0, type: LoadingComponent, deps: [{ token: i1$5.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.3", ngImport: i0, type: LoadingComponent, decorators: [{
    ...
    <div class="loading">
      <div [style.height]="height+'px'" [innerHTML]="svg"></div>
        ...
        }], ctorParameters: () => [{ type: i1$5.DomSanitizer }], propDecorators: { height: [{
                type: Input
            }] } });
...
export { FileManagerComponent, FirebaseStorageService };
